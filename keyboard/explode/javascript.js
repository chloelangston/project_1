		...
		if(clicked === false) {
			...
			$('.clipped-box div:not(.content)').each(function() {
				...
				var v = rand(120, 90),
					...
					g = -4.8; // And gravity is -9.8. If you live on another planet feel free to change
				...
				var color = $(this).css('backgroundColor').split('rgb(')[1].split(')')[0].split(', '),
					colorR = rand(0, 40),  // You might want to alter these manually if you change the color
					colorGB = rand(0, 40),  // To get the right consistency.
